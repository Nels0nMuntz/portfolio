...
const menuItems = [
  ...
  { name: "Servicess", href: "#servicess", iconClassName: "uil-briefcase" },
...
export default function Header() {
  ...
  return (
    <header
      ...
      data-shadow={visibleShadow ? "visible" : ""}
    >
      <nav className="h-[var(--header-height)] flex justify-between items-center gap-4 container">
        ...
        <div
          ...
          data-state={visibleMenu ? "visible" : ""}
        >
          <div hidden={!visibleMenu} aria-hidden={visibleMenu ? "false" : "true"}>
