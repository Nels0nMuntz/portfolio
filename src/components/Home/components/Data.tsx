...
export default function Data() {
  return (
    <div className="col-span-3 md:col-auto">
      <h1 className="flex justify-start md:flex-col-reverse items-end md:items-start gap-2 text-4xl xs:text-large xs:leading-[4rem] mb-1">
        <span className="w-min sm:w-auto">Eugene Chekerdes</span>
        <svg
          width="36"
          height="36"
          viewBox="0 0 48 48"
          ...
          className="w-[22px] xs:w-[26px] h-[22px] xs:h-[26px] xm:w-9 xm:h-9 mb-5 md:mb-0"
        >
          <path
      ...
      <h2 className="relative pl-[3.75rem] xm:pl-20 mb-4 text-h3 font-normal before:absolute before:left-0 before:top-[0.7rem] before:w-[42px] xm:before:w-[70px] before:h-[1px] before:bg-dark-3">
        Frontend Developer
      </h2>
